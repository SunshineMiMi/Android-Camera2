...
public class Camera2Activity extends Activity implements SurfaceTextureListener {
	...
	public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
		...
		try {
			...
			if (CameraIdList != null && CameraIdList.length > 0) {
				Log.d("", "---cameraList = " + CameraIdList.length);
				// 获取可用相机设备列表
...
//				CameraCharacteristics.LENS_FACING_BACK;
				...
				Toast.makeText(getBaseContext(), "无可用相机设备!", Toast.LENGTH_SHORT).show();
			}
